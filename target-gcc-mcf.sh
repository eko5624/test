...
wget -c -O mcfgthread-1.8-ga.4 https://github.com/lhmouse/mcfgthread/archive/refs/tags/v1.8-ga.4.tar.gz 2>/dev/null >/dev/null
tar xzf mcfgthread-1.8-ga.4 2>/dev/null >/dev/null

echo "building mcfgthread"
echo "======================="
cd $M_SOURCE/mcfgthread-1.8-ga.4
meson setup build \
  --prefix=$M_TARGET \
